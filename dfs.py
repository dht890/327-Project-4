...
class DFSClient:
    ...
    def append(self, fileName, localPath):
        ...
        #store page content in chord and update metadata with new page descriptor and updated file size, number of pages, version number
        pageNo = meta.numPages
        pageKey = self.pageKey(fileName, pageNo)
        pageData = {"pageNo": pageNo, "content": content}
        self.chordNode.put(pageKey, json.dumps(pageData))
